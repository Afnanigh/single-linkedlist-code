...
public void display(){
    Node <E> temp=head;
    while(temp!=null){//ينفذ كل شي الا الاخير====temp.getNext()
        //temp!=null
...
public class NewClass {
  public static void main(String[]args){
      Scanner input=new Scanner(System.in);
         System.out.println("*Please enter size the first data");
         int first=input.nextInt();
         SinglyLinkedListS<Integer> fr=new SinglyLinkedListS();
         ...
         System.out.println("please entersize  the second data");
         int sco=input.nextInt();
           SinglyLinkedListS<Integer> sc=new SinglyLinkedListS();
           System.out.println("please enter the element");
           for(int i=0;i<sco;i++){
               int ele=input.nextInt();
               sc.addLast(ele);
           }
          System.out.println("the first givin Lnked list");
          fr.display();
          System.out.println("the second givin linked list");
          sc.display();
             SinglyLinkedListS<Integer> marg=new SinglyLinkedListS();
              for(int i=0;i<first;i++){
                 int ele=fr.removeFirst();
                 fr.addLast(ele);
                 marg.addLast(ele);
              }
               for(int i=0;i<sco;i++){
                   int el=sc.removeFirst();
                   sc.addLast(el);
                   marg.addLast(el);
